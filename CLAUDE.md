...
- **Tablero**: matriz `ROWS × COLS` de enteros. `0` = vacía; `1–7` = índice compartido en `COLORS` y `PIECES`. El mismo entero identifica pieza y color, así que añadir una pieza obliga a extender ambos arrays en paralelo.
